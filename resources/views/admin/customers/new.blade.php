        ...
        <form action="{{route('admin.customers.store')}}" enctype="multipart/form-data" method="POST">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="customer[name]" class="form-control" id="customer-name" placeholder="Nhập tên khách hàng">
                </div>
                <div class="form-group">
                    <label>Mô tả</label>
                    <input type="text" name="customer[description]" class="form-control" id="description" placeholder="Mô tả nhỏ">
                </div>
                <div class="form-group">
                    <div>
