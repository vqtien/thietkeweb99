...
@section('content') 
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{route('admin.blogs.store')}}" enctype="multipart/form-data" method="POST" class="formAjax">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" required name="blog[name]" class="form-control" id="blog-name" placeholder="Nhập tên blog">
                </div>
                <div class="form-group">
                    <label>Mô tả</label>
                    <input type="text" name="blog[description]" class="form-control" id="description" placeholder="Mô tả nhỏ">
                </div>
