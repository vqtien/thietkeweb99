 ...
 @section('title', 'Liên hệ thiết kế website')
 @section('seo')
     <meta name=description
         content="Hãy điền đầy đủ thông tin và các yêu cầu về trang web mà bạn muốn thiết kế, chúng tôi sẽ liên hệ với bạn để tư vấn chi tiết.">
 @stop
                 ...
                 <div class="row justify-content-center justify-content-lg-between">
                     <div class="col-lg-6 col-md-8 order-2 order-lg-0">
                         <div class="section-title-two mb-30">
                             <h2 class="sub-title">Bạn có nhu cầu thiết kế website<span>?</span></h2>
                         </div>
                         <div class="contact-wrap-content">
                             <p>Hãy điền đầy đủ thông tin và các yêu cầu về trang web mà bạn muốn thiết kế, chúng tôi sẽ
                                 liên hệ với bạn để tư vấn chi tiết.</p>
